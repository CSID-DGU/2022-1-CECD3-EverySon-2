...
from transformers.models.roberta.modeling_roberta import RobertaEmbeddings as hugRobertaEmbeddings, RobertaEncoder, \
    RobertaPooler, _TOKENIZER_FOR_DOC, _CHECKPOINT_FOR_DOC, _CONFIG_FOR_DOC
...
class RobertaEmbeddings(hugRobertaEmbeddings):
